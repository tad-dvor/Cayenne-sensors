// This example shows how to connect Gas sensor to Cayenne using a manually specified Ethernet connection and send/receive sample data.
...
void loop() {
    ...
    Cayenne.virtualWrite(1, gas, "analog_sensor", "null");
	}
}
